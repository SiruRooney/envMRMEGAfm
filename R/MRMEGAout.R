...
#'
#' @description A meta-analysis results of genetic variants across all the genome. This approach uses genome-wide metrics of diversity between populations
...
#'
#'@format A dataframe with 301 genetic variants and 17 variables:
#'\describe{
