...
`r colorize("Note", "blue")`: - If PCs are not available, `MR_mega_MDS` function implemented in [env.MRMEGA](https://SiruRooney.github.io/env.MRmega/) package is used for calculating PCs by inputting the file containing all GWAS files location and the number of PCs.
